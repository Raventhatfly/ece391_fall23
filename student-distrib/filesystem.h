...
int32_t directory_read(const uint8_t *dirname);
int32_t file_open(const uint8_t *fname, const uint8_t *mode);
int32_t file_read(int32_t fd);
int32_t file_write(int32_t fd);
int32_t file_close(int32_t fd);
int32_t dir_open(const uint8_t *fname, const uint8_t *mode);
